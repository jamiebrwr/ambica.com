...
background: url(<?php echo $login_logo; ?>) center center no-repeat; <?php } ?>
width: <?php echo $this->get_wps_option('admin_logo_width'); ?>px; height:<?php echo $this->get_wps_option('admin_logo_height'); ?>px; margin: 0 auto 20px; }
...
<?php echo $this->get_wps_option('login_custom_css'); ?>
